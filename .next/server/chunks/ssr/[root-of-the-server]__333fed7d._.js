...
`;a.s(["homepageQuery",0,c,"postsQuery",0,e,"preacherQuery",0,d,"sermonsQuery",0,f],557944)},779353,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(211857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/components/LazyYouTube.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/LazyYouTube.tsx <module evaluation>","default")},47986,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(211857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/components/LazyYouTube.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/LazyYouTube.tsx","default")},422641,a=>{"use strict";a.i(779353);var b=a.i(47986);a.n(b)},523022,a=>{"use strict";var b=a.i(907997),c=a.i(497281),d=a.i(557944),e=a.i(213557),f=a.i(495774),g=a.i(422641),h=a.i(843167);async function i({params:a}){let b=await c.client.fetch('*[_type == "preacher" && slug.current == $slug][0]',{slug:a.slug});return{title:`${b?.name} Sermons | ThaGospel Church`,description:`Browse all sermons by ${b?.name} from ThaGospel Church.`,openGraph:{title:`${b?.name} Sermons | ThaGospel Church`,description:`Browse all sermons by ${b?.name} from ThaGospel Church.`,type:"website"}}}async function j({params:a}){let i=await c.client.fetch(d.preacherQuery,{slug:a.slug},{next:{revalidate:60}}),j=await c.client.fetch('*[_type == "sermon" && preacher._ref == $id] | order(date desc)',{id:i._id},{next:{revalidate:60}});return(0,b.jsxs)("div",{children:[(0,b.jsx)(e.default,{}),(0,b.jsxs)("main",{children:[(0,b.jsx)("section",{className:"bg-navy text-white py-20",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 text-center",children:[(0,b.jsx)("h1",{className:"text-4xl md:text-6xl font-bold mb-4 font-inter",children:i.name}),(0,b.jsxs)("p",{className:"text-xl font-inter",children:["Sermons by ",i.name,"."]}),i.photo&&(0,b.jsx)("img",{src:(0,h.urlFor)(i.photo).url(),alt:i.name,className:"w-32 h-32 rounded-full mx-auto mt-8 object-cover"}),(0,b.jsx)("p",{className:"text-lg mt-4 max-w-2xl mx-auto",children:i.bio})]})}),(0,b.jsx)("section",{className:"py-16 bg-white",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4",children:[(0,b.jsxs)("h2",{className:"text-3xl font-bold mb-8 text-center",children:["Sermons by ",i.name]}),0===j.length?(0,b.jsx)("div",{className:"text-center py-16",children:(0,b.jsx)("p",{children:"No sermons found by this preacher."})}):(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:j.map(a=>{let c,d;return(0,b.jsxs)("div",{className:"bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow",children:[(d=(c=(a.videoUrl||"").match(/(?:youtube\.com\/embed\/|youtu\.be\/|youtube\.com\/watch\?v=)([^&\n?#]+)/))?c[1]:null)?(0,b.jsx)("div",{className:"mb-4 aspect-video",children:(0,b.jsx)(g.default,{videoId:d,title:a.title})}):null,(0,b.jsx)("h3",{className:"text-xl font-bold mb-2",children:a.title}),(0,b.jsxs)("p",{className:"text-gray-600 mb-2",children:["By ",a.preacher.name]}),(0,b.jsx)("p",{className:"text-sm text-gray-500 mb-2",children:new Date(a.date).toLocaleDateString()}),a.scripture&&(0,b.jsxs)("p",{className:"text-sm text-gray-700 mb-4",children:["Scripture: ",a.scripture]}),(0,b.jsxs)("div",{className:"flex space-x-2",children:[a.videoUrl&&(0,b.jsx)("a",{href:a.videoUrl,target:"_blank",rel:"noopener noreferrer",className:"bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700",children:"Watch"}),a.audioUrl&&(0,b.jsx)("a",{href:a.audioUrl,target:"_blank",rel:"noopener noreferrer",className:"bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700",children:"Listen"})]})]},a._id)})})]})})]}),(0,b.jsx)(f.default,{})]})}a.s(["default",()=>j,"generateMetadata",()=>i,"revalidate",0,60])},609489,a=>{a.v(b=>Promise.all(["server/chunks/ssr/node_modules_@sanity_client_dist__chunks-es_stegaEncodeSourceMap_e91a1003.js"].map(b=>a.l(b))).then(()=>b(614025)))},276016,a=>{a.v(b=>Promise.all(["server/chunks/ssr/[root-of-the-server]__67ed145b._.js"].map(b=>a.l(b))).then(()=>b(312374)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__333fed7d._.js.map