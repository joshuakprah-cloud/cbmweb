      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({ name: 'name', title: 'Service Name', type: 'string', description: 'Display name on homepage (overrides Service Type if set)' }),
            ...
            defineField({ name: 'showOnHomepage', title: 'Show on Homepage', type: 'boolean', initialValue: true, description: 'Display this service in the weekly services section on the homepage' }),
