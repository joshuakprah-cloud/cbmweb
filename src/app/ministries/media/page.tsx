...
export const metadata: Metadata = {
  title: 'Media Ministry - ThaGospel Church',
  description: 'Join our media team. Use your technical skills to amplify the church\'s message through audio, video, and social media.',
};
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10 text-center">
          ...
          <p className="mt-6 text-xl text-white/90 leading-relaxed max-w-3xl mx-auto drop-shadow-md">
            Amplifying the message through technology
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-[#F8F9FB]">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-700 text-lg leading-relaxed">
            The Media Ministry at ThaGospel Church uses technology to spread the Gospel near and far. 
            We handle live streaming, sound engineering, video production, photography, and social media 
            management. Our team ensures that every service is captured and shared with those who cannot 
            attend in person, extending our reach to the ends of the earth.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-[#F8F9FB]">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <h3 className="text-xl font-bold text-[#0B1F3A] mb-6 text-center">Media Teams</h3>
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start gap-4 py-3 border-b border-gray-100">
                ...
                <div>
                  <span className="font-medium block">Audio/Sound Engineering</span>
                  <span className="text-sm text-gray-500">Mixing and live sound management</span>
                </div>
              </div>
              <div className="flex items-start gap-4 py-3 border-b border-gray-100">
                <span className="text-[#0d9488] font-bold text-xl">•</span>
                <div>
                  <span className="font-medium block">Video & Live Streaming</span>
                  <span className="text-sm text-gray-500">Camera operation and broadcast</span>
                </div>
              </div>
              <div className="flex items-start gap-4 py-3 border-b border-gray-100">
                <span className="text-[#0d9488] font-bold text-xl">•</span>
                <div>
                  ...
                  <span className="text-sm text-gray-500">Capturing moments and events</span>
                </div>
              </div>
              <div className="flex items-start gap-4 py-3">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-500">Content creation and management</span>
                </div>
              </div>
            </div>
          </div>
