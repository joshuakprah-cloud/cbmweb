  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Sermons',
        item: 'https://thagospel.com/sermons',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: sermonData.title,
        item: `https://thagospel.com/sermons/${params.slug}`,
      },
    ],
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            {sermonData.seriesTitle && (
              <div>
                ...
                <a
                  href={`/sermons?series=${sermonData.seriesSlug}`}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center py-12">
            ...
            <a
              href={`/sermons/preachers/${sermonData.speaker.slug}`}
              className="inline-flex items-center text-teal-600 hover:text-teal-700 font-medium transition-colors"
            >
              View All Sermons
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
