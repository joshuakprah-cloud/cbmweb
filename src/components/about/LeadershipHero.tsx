...
export default function LeadershipHero({
  ...
  description = "Meet the dedicated individuals who serve and lead our church. Our leadership team is committed to guiding our community with wisdom, faith, and servant hearts."
}: LeadershipHeroProps) {
  return (
    <section 
      role="banner"
