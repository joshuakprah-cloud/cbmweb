...
const ContactInfoPanel: React.FC<ContactInfoPanelProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6" aria-label="Contact information">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Contact Information</h2>
      
      {/* Address */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Address</h3>
        <p className="text-gray-600 mb-2">{address || CONTACT_FALLBACKS.address}</p>
        <a
      ...
      {officeHours && officeHours.length > 0 && (
        <div className="mb-6" aria-label="Office hours">
